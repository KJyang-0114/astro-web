...
export const insightPosts: InsightPost[] = [
  {
    slug: "small-business-hero-section-checklist",
    date: "2026-06-16",
    category: "首頁設計",
    title: "小商家網站首頁第一屏應該放什麼？",
    description:
      "小商家網站第一屏要讓訪客快速看懂服務、地區、信任感和聯絡方式，而不是只放漂亮大圖或空泛標語。",
    summary:
      "首頁第一屏不是拿來塞滿特效的地方。訪客通常只想快速判斷：這是不是我要的服務、能不能服務我的地區、可不可信、下一步怎麼聯絡。",
    takeaways: [
      "第一屏要同時回答服務、地區、信任和行動入口。",
      "標題要具體，不要只寫品牌口號。",
      "CTA 要接近客戶當下意圖，例如 LINE 詢價、預約、看案例或諮詢。"
    ],
    sections: [
      {
        title: "先講清楚你做什麼，不要只講你很專業",
        body:
          "很多商家首頁第一句會寫成「用心服務、品質保證」這類句子，但訪客還是不知道你到底做冷氣安裝、牙醫預約、補習試聽、室內設計還是清潔服務。第一屏標題應該直接包含主要服務和適用對象。"
      },
      {
        title: "服務地區要早點出現",
        body:
          "在地服務業最常見的問題是訪客不確定你有沒有服務他那一區。首頁第一屏可以放城市、區域、到府範圍或主要服務地點。這同時幫助人和搜尋系統理解網站主題。"
      },
      {
        title: "信任感不用很長，但要有證據",
        body:
          "第一屏不一定要塞滿案例，但至少可以放一個信任線索，例如評價數、服務年資、真實案例、營業時間、診所醫師、施工流程或可先傳照片估價。重點是讓訪客願意繼續往下看。"
      },
      {
        title: "CTA 要符合行業，不要每個網站都一樣",
        body:
          "冷氣服務適合 LINE 照片詢價，牙醫適合預約，補習班適合試聽，室內設計適合看作品或諮詢。CTA 不是裝飾按鈕，而是訪客看懂服務後最自然的下一步。"
      }
    ],
    faq: [
      {
        question: "首頁第一屏一定要放電話或 LINE 嗎？",
        answer: "不一定兩個都要很大，但至少要有明顯聯絡入口。台灣小商家通常建議保留 LINE，因為客戶可以傳照片、需求和預算。"
      },
      {
        question: "第一屏可以放形象大圖嗎？",
        answer: "可以，但圖片不能壓過資訊。訪客仍要能快速看懂服務、地區、信任線索和下一步 CTA。"
      },
      {
        question: "KJyang Studio 會怎麼設計第一屏？",
        answer: "會依產業意圖調整。急件服務強調快速聯絡，診所強調信任和預約，補習班強調試聽和成果，設計類網站則強調作品和諮詢流程。"
      }
    ]
  },
  {
